...
##
# Java VM flags
JAVA_FLAGS='-Djava.io.tmpdir=/media/data/tmp -Djava.net.useSystemProxies=true -Xmx256g -Dcom.sun.management.jmxremote.port=3335 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false'
